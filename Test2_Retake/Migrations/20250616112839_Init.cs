    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Character",
                columns: new[] { "CharacterId", "CurrentWeight", "FisrtName", "LastName", "MaxWeight" },
                values: new object[,]
                {
                    { 1, 43, "John", "Yakuza", 200 },
                    { 2, 81, "Peter", "Lewis", 120 },
                    { 3, 11, "Juan", "Baustista", 80 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 1, 2, new DateTime(2024, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, 3, new DateTime(2024, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
